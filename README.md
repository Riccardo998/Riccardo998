...
![Radar Chart](https://quickchart.io/chart?c={type:'radar',data:{labels:['AI','Software Engineering','IoT','Recommender Systems','Databases'],datasets:[{label:'Skill Level',data:[9,8,7,8,7]}]}})
